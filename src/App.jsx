    ...
    <div className='app'>
      {
        ...
        ?(
          <div>
            <h1><img src="./src/components/images/barra-de-carga.png" alt="" width="100px"   /></h1>
        ...
        :(
          hasError
          ? <h1>Para obtener el clima de tu ciudad, por favor no bloquies la ubicación<img src="./src/components/images/error.png" alt="" width="400px" /></h1>
          :(
          <WeatherCard
      weather={weather}
      temp = {temp}
